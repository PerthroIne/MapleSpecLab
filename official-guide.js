 ...
 * Verified against the guide updated on 2026-08-07.
 */
(function () {
  ...
  const stats = {
    ...
    max_damage: { title: "최대 데미지 배율", summary: "각 타격 피해가 정해지는 최대 범위입니다.", detail: "최소·최대 데미지 배율 사이에서 타격 피해가 정해집니다. 연구소 비교 지수는 두 값의 평균을 사용합니다.", section: "능력치 사전 · 4.2" },
    ...
    status_damage: { title: "상태이상 데미지", summary: "빙결·기절·무력화 등 상태이상에 걸린 적에게 주는 피해를 늘립니다.", detail: "대상이 해당 상태일 때만 공식 일반 피해 계산에 반영됩니다. 연구소 기본 비교 지수에는 상태 발동률·유지시간이 포함되지 않습니다.", section: "능력치 사전 · 1.3", limitation: true },
    hp: { title: "최대 HP", summary: "생존의 기준이 되는 능력치입니다. 남은 HP가 0이 되면 전투 불능이 됩니다.", detail: "공식 전투력 및 일부 최대 HP 비례 피해에 사용됩니다. 연구소 공격 비교 지수에는 직접 반영되지 않습니다.", section: "능력치 사전 · 2.3 · 3.1", limitation: true },
    ...
    evasion: { title: "회피", summary: "상대 공격을 빗나가게 하는 능력치입니다.", detail: "상대 명중과의 차이로 판정됩니다. 연구소 공격 비교 지수에는 상대 명중과 콘텐츠 조건이 없어 직접 반영되지 않습니다.", cap: "회피 확률 상한 70%", section: "1.2 · 능력치 사전", limitation: true }
  };

  const topics = {
    comparisonModel: { title: "연구소 비교 지수", summary: "동일한 연구소 모델 안에서 변경 전후의 방향과 상대 차이를 비교하기 위한 값입니다.", detail: "공식 전투력이나 실제 DPS가 아닙니다. 대상 방어력, 스킬 계수·특성, 콘텐츠 보정, 레벨/PVP 보정, 전투 상황을 모두 입력받지 않으므로 게임 결과를 보장하지 않습니다.", section: "공식 가이드 1.3 · 2 · 3.1", limitation: true },
